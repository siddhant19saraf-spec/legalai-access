  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6" noValidate role="form" aria-label="Legal question form">
      <div>
        ...
        <div className="relative">
          <Textarea
            ...
            maxLength={5000}
          />
          <div className="absolute bottom-2 right-2 text-xs text-gray-500 dark:text-gray-400" aria-hidden="true">
            {charCount} / 5000
          </div>
        </div>
        <p id="legal-question-hint" className="mt-1.5 text-sm text-gray-600 dark:text-gray-400" role="status">
      ...
      <details className="group" open={showContext}>
        ...
        >
          <svg
            className="w-4 h-4 text-gray-600 dark:text-gray-400 transition-transform group-open:rotate-90 flex-shrink-0"
            viewBox="0 0 20 20"
            fill="currentColor"
            aria-hidden="true"
          >
