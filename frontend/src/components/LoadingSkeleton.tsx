  ...
  return (
    <div className="space-y-6 animate-pulse" aria-hidden="true">
      ...
      <div className="space-y-3">
        <div className="h-20 bg-gray-200 rounded border" />
        <div className="h-20 bg-gray-200 rounded border" />
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <div className="w-10 h-10 bg-gray-200 rounded-lg border-2" />
          <div className="w-10 h-10 bg-gray-200 rounded-lg border-2" />
          <div className="w-10 h-10 bg-gray-200 rounded-lg border-2" />
          <div className="w-10 h-10 bg-gray-200 rounded-lg border-2" />
          <div className="w-10 h-10 bg-gray-200 rounded-lg border-2" />
...
export function SourceCardSkeleton() {
  return (
    <article className="p-4 bg-white border border-gray-200 rounded-lg animate-pulse" aria-hidden="true">
